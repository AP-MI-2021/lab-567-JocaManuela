from Domain.Cheltuiala import create_cheltuiala, get_nr_apartament, get_suma, get_data, get_tipul, set_nr_apartament, set_suma, \
                            set_data, set_tipul

def test_cheltuiala():
    cheltuiala = create_cheltuiala(3, 110, '19.10.2021', 'intretinere')
